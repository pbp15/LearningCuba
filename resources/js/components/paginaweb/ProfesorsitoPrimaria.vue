<template>
    ...
    <div class="contenedor" v-if="arrayProfesore" >
                        <div v-for="profesore in arrayProfesore" :key="profesore.id"   class="info-pet">
                                <img :src="'imagepage/profesores/'+ profesore.imagen" >
